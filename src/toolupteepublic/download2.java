 ...
 * @author me
 */
public class download2 extends javax.swing.JFrame {
...
//                gr.get("validate"), gr.get("seccode")));
		...
		elem2.sendKeys("D:\\developdemo\\spy\\a\\51A7ObLTGVL.png");*/
            ...
            for (Image image : listacc) {
                ...
                driver.findElement(By.cssSelector("div#primary_color_tshirt div.dd-select")).click();
                Thread.sleep(500);
                driver.findElement(By.cssSelector("div#primary_color_tshirt div.dd-click-off-close li:nth-child(4) a")).click();
                Thread.sleep(500);
                driver.findElement(By.cssSelector("div#primary_color_baseballtee div.dd-select")).click();
                Thread.sleep(500);
                driver.findElement(By.cssSelector("div#primary_color_baseballtee div.dd-click-off-close li:nth-child(2) a")).click();
...
//                Thread.sleep(500);
                ...
                System.out.println("can giua ");

                List<WebElement> listClickHalign = driver.findElement(By.cssSelector("div.m-uploader-toolbar_tool-h-align"));

                for (WebElement webElement : listClickHalign) {
                    webElement.sendKeys(Keys.ENTER);
                }
                Thread.sleep(500);
                listClickHalign = driver.findElement(By.cssSelector("div.m-uploader-toolbar_tool-top-align"));

                for (WebElement webElement : listClickHalign) {
                    webElement.sendKeys(Keys.ENTER);
                }
                Thread.sleep(500);
                listClickHalign = driver.findElement(By.cssSelector("div.m-uploader-toolbar_tool-v-align"));
...
//                js.executeScript("$('.m-uploader-toolbar_tool-v-align').click();");
                Thread.sleep(500);
                WebElement element_terms = driver.findElement(By.cssSelector("input#terms"));
                element_terms.click();
...
//	}
    ...
    private void buttonChosefoderActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void linkSaveFileActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void textURLForderActionPerformed(java.awt.event.ActionEvent evt) {                                              
        // TODO add your handling code here:
    }                                             
